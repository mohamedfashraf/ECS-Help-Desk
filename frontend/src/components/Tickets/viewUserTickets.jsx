  ...
  useEffect(() => {
    const fetchTickets = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:3000/api/tickets/users/", {
          headers: {
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            {/* <th scope="col" className="px-4 py-4">User ID</th> */}
                            ...
                            {/* <th scope="col" className="px-4 py-4">Assigned To</th> */}
                            <th scope="col" className="px-4 py-4">Resolution Details</th>
                    ...
                    <tbody>
                        {tickets.map((ticket) => (
                            <tr key={ticket._id} className="border-b dark:border-gray-700">
